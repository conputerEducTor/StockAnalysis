...
try:
    ...
    def bhavcopy_display():
        ...
        st.write(f"{segment} data excel sheet for {req_date}")

        st.download_button(
            "Download", bhavcopy.to_csv(), file_name=f"{segment}_excel_{req_date}.csv"
        )
        st.write(bhavcopy)
    ...
    with st.sidebar:
        st.markdown(
            'GitHub  :) </br>[!["GitHub"](https://img.icons8.com/glyph-neue/64/000000/github.png)](https://github.com/conputerEducTor)',
